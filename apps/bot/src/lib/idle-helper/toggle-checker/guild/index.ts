...
import {
  _toggleTeamRaidHelper,
  _toggleTeamRaidReminder
...
export type IToggleGuildCheckerReturnType = Awaited<
  ReturnType<typeof toggleGuildChecker>
>;

const toggleGuildChecker = async ({
  guildRoleId,
  serverId
}: IToggleGuildChecker) => {
