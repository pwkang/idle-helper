      ...
      items: [
        {
          ...
          info: [
            ...
            },
            {
              ...
              image: 'https://cdn.discordapp.com/attachments/1134079345976148024/1157718641819791480/raid-helper-demo.gif',
            },
          ],
        },
      ],
      ...
      fields: [
        {
          ...
          value: [`Join the [support server](${SUPPORT_SERVER_INVITE_LINK}) and ask us`],
        },
      ],
    },
    selectMenu: {
      ...
      items: [
        {
          ...
          commands: [
            ...
            {
              name: ['I only want to use certain features, can I turn off the others?'],
              description: [
        ...
        },
        {
          ...
          commands: [
            ...
            {
              name: [`\`${PREFIX.bot}guild p\` is not showing all guild members, how to register them?`],
              description: [
